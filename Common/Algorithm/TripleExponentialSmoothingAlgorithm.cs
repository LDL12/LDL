...
namespace Common.Algorithm
{
    ...
    public class TripleExponentialSmoothingAlgorithm
    {
        ...
        /// <returns></returns>
        public decimal CalcAccuratePredictiveValue(decimal[]? data, decimal increment = 0.1M)
        {
        ...
        /// <returns></returns>
        public decimal CalcAlphaPredictiveValue(decimal[] data, decimal alpha)
        {
        ...
        /// <returns></returns>
        decimal CalcPredictiveValue(decimal st1, decimal st2, decimal st3, decimal alpha, int T = 1)
        {
        ...
        /// <returns></returns>
        decimal[] SingleExponentialSmoothing(decimal[] data, decimal alpha, decimal s0)
        {
        ...
        /// <returns></returns>
        Tuple<decimal[], decimal[], decimal[]> TripleExponentialSmoothing(decimal[] data, decimal alpha)
        {
            if (data.Length < 3)
            {
